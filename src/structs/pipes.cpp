...
void Pipes::Removing_each_station(HashStations stations_copy, int chs_fl, Pipes pipes_copy, HashCities cities_copy, HashReservoirs reservoirs_copy) {
...
void Pipes::Removing_specific_station(string input, int chs_fl, HashStations stations_copy, HashCities cities_copy, HashReservoirs reservoirs_copy, Pipes pipes_copy ) {
    for (const auto& a: stations_copy.stationsTable) {
        if (a.getCode() == input) {
            pipes_copy.ReadLines_copy_station(a, chs_fl);
            pipes_copy.pipes_copy.addVertex("super_source");
