                        ...
                        case 2:
                            ...
                            switch (decision) {
                                case 1:
                                    ...
                                    Pipes::Removing_each_station(stations_copy, chs_fl, pipes_copy, cities_copy, reservoirs_copy);
                                    break;
                                ...
                                case 2 :
                                    ...
                                    Pipes::Removing_specific_station(input, chs_fl, stations_copy, cities_copy,reservoirs_copy, pipes_copy);
